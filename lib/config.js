...
export default {
  projectDir: {
    title: 'Project Dir where elm.json exists',
    description: 'Path to the `elm` executable.  This can be an absolute path or relative to the directory of `elm.json`.',
    type: 'string',
    default: '/Users/girish/work/phd/PHDSys-webapp/hippo',
    order: 0,
  },
  // Compilation
